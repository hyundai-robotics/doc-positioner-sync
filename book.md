...
8. 제어기 전원을 재투입하면 부가축, 스테이션, 메커니즘 설정이 정상적으로 적용됩니다.# 2.2 로봇 캘리브레이션

[**Hi6 로봇제어기 조작설명서 7.7장 자동 캘리브레이션**](https://hrbook-hrc.web.app/#/view/doc-hi6-operation/korean-tp630/7-setting/7-auto-calibration/README)을 참고하십시오.# 2.3 포지셔너 캘리브레이션
...
![](../../_assets/image9.png)# 2.3.2 2축 포지셔너 캘리브레이션 프로그램 교시
1.	교시할 프로그램을 선택합니다.
...
![](../../_assets/image10.png)# 2.3.3 포지셔너 캘리브레이션 실행
...
5. [**3.2장 포지셔너 동기 조그 모드**](https://hrbook-hrc.web.app/#/view/doc-positioner-sync/korean/3-manual-operation/3-2-positioner-sync-jog-mode)에서 캘리브레이션이 정상적으로 수행되었는지 확인할 수 있습니다.# 2.3.4 posi_calib
...
- 포지셔너 메커니즘: J7+J8
- 좌표계: 축 좌표계(단독 조그)
- 기록 조건: 일반 move 명령# 3.2 포지셔너 동기 조그 모드
...
![](../_assets/image14-1.png)# 4. 프로그램 작성
# 4.1 스텝 기록
