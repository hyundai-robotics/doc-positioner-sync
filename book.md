...
# 2. System Settings# 2.1 System Initialization
...
</br># 2.3.2 Teaching the 2-Axis Positioner Calibration Program
...
- Synchronized Jog: Jogging the positioner while the robot moves synchronously to follow it.# 3.1 Positioner Independent Jog Mode
